                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <label class="col-lg col-form-label" for="office">Select Office</label>
                            ...
                            <div class="form-group row">
                                <label for="survey_title" class="col-lg col-form-label">Title</label>
                                <input type="text" class="form-controloffice" id="survey_title"
                                    placeholder="Survey Title" required>
                            </div>
                            <div class="form-group row">
                                <label for="objective" class="col-lg col-form-label">Objective</label>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group row radio">
                                <label class="col-lg-3 col-form-label" for="anonymous">Is Anonymous</label>
                            ...
                            <div class="form-group row radio">
                                <label class="col-lg-3 col-form-label" for="publish">Is Published</label>
                            ...
                            <div class="form-group row">
                                ...
                                <input class="col-lg-9 form-controloffice" type='date' name="start_date" id="start_date"
                                    required>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label" for="end_date">End Date</label>
                                <input class="col-lg-9 form-controloffice" type='date' name="end_date" id="end_date"
                                    required>
                            </div>
                        </div>
                    </div>
        ...
        function renderQuestion() {
            let questionHtml = `
                <div id="question-block-${questionCount}" class="question-block">
                    <div class="form-group row">
                        <label for="question_number_${questionCount}" class="col-lg-2">Question Number ${questionCount}</label>
                    </div>
                    <div class="form-group row">
                        <label for="question_text_${questionCount}" class="col-lg col-form-label">Question Text</label>
                        <textarea class="col-lg-11 form-control" id="question_text_${questionCount}" placeholder="Enter Question Description" required>${questions[questionCount - 1]?.question_text || ''}</textarea>
                    </div>
                    <div class="form-group row">
